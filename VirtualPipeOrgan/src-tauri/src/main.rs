...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::notation_set_take_visible,
            commands::notation_start_recording,
            commands::notation_stop_recording,
            commands::notation_delete_events,
            commands::notation_transpose,
